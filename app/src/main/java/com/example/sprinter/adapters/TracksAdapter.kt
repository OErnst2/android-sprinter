...
import com.example.sprinter.activities.TrackScreenActivity
...
class TracksAdapter(private val tracks: List<Track>, private val context: Context?) : RecyclerView.Adapter<TracksAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        view.setOnClickListener {
            ...
            val intent = Intent(parent.context, TrackScreenActivity::class.java)
